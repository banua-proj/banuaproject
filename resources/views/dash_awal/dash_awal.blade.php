...
<head>
    ...
    <!-- Google font-->
    <link href="{{ asset('adminty/assets/pages/font_google/font.css') }}" rel="stylesheet">
    <!-- Required Fremwork -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('adminty/assets/css/pcoded-horizontal.min.css') }}">
</head>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index-1.htm">
                            <img class="img-fluid" src="adminty/assets/images/logo.png" alt="Theme-Logo">
                        </a>
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification notification-view dropdown-menu" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="adminty/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                        ...
                                        <li>
                                            <div class="media">
                                                <img class="d-flex align-self-center img-radius" src="adminty/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                                <div class="media-body">
                           ...
                           <!--  <li class="header-notification">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        <img src="adminty/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                        <span>John Doe</span>
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu">
                                ...
                                <ul class="pcoded-submenu">
                                    ...
                                    <li class="">
                                        <a href="extra-pages/landingpage/index.htm" target="_blank" data-i18n="nav.landing-page.main"> <span class="pcoded-micon"><i class="ti-mobile"></i></span> <span class="pcoded-mtext">Landing Page</span> <span class="pcoded-mcaret"></span> </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="pcoded-hasmenu">
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            ...
                                            <li class="pcoded-hasmenu ">
                                                ...
                                                <ul class="pcoded-submenu">
                                                    <li class="">
                                                        <a href="extra-pages/email-templates/email-welcome.htm" data-i18n="nav.email.email-template.welcome-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="extra-pages/email-templates/email-password.htm" data-i18n="nav.email.email-template.reset-password">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="extra-pages/email-templates/email-newsletter.htm" data-i18n="nav.email.email-template.newsletter-email">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="extra-pages/email-templates/email-launch.htm" data-i18n="nav.email.email-template.app-launch">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    ...
                                                    <li class="">
                                                        <a href="extra-pages/email-templates/email-activation.htm" data-i18n="nav.email.email-template.activation-code">
                                                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                ...
                                <div class="main-friend-list">
                                    <div class="media userlist-box" data-id="1" data-status="online" data-username="Josephin Doe" data-toggle="tooltip" data-placement="left" title="Josephin Doe">
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius img-radius" src="adminty/assets/images/avatar-3.jpg" alt="Generic placeholder image ">
                                    ...
                                    <div class="media userlist-box" data-id="2" data-status="online" data-username="Lary Doe" data-toggle="tooltip" data-placement="left" title="Lary Doe">
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius" src="adminty/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                            <div class="live-status bg-success"></div>
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media userlist-box" data-id="3" data-status="online" data-username="Alice" data-toggle="tooltip" data-placement="left" title="Alice">
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius" src="adminty/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                            <div class="live-status bg-success"></div>
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media userlist-box" data-id="4" data-status="online" data-username="Alia" data-toggle="tooltip" data-placement="left" title="Alia">
                                        <a class="media-left" href="#!">
                                            <img class="media-object img-radius" src="adminty/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                            <div class="live-status bg-success"></div>
                                        </a>
                                        <div class="media-body">
                ...
                <div class="showChat_inner">
                    ...
                    <div class="media chat-messages">
                        <a class="media-left photo-table" href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="adminty/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                        </a>
                    ...
                    <div class="media chat-messages">
                        ...
                        <div class="media-right photo-table">
                            <a href="#!">
                                <img class="media-object img-radius img-radius m-t-5" src="adminty/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                            </a>
                        </div>
                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row m-b-25">
                                                            <div class="col-auto p-r-0">
                                                                <div class="u-img">
                                                                    <img src="adminty/assets/images/breadcrumb-bg.jpg" alt="user image" class="img-radius cover-img">
                                                                    <img src="adminty/assets/images/avatar-2.jpg" alt="user image" class="img-radius profile-img">
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <h6 class="m-b-5">John Deo</h6>
                                                                <p class="adminty/text-muted m-b-0">Lorem Ipsum is simply dummy text.</p>
                                                                <p class="adminty/text-muted m-b-0"><i class="feather icon-clock m-r-10"></i>2 min ago</p>
                                                            </div>
                                                        </div>
                                                        <div class="row m-b-25">
                                                            <div class="col-auto p-r-0">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card wather-card">
                                                    <div class="nature-card">
                                                        <img src="adminty/assets/images/widget/wathernature.png" alt="whether image" class="img-fluid main-img">
                                                        <img src="adminty/assets/images/widget/watherstar1.png" alt="whether image" class="snow1">
                                                        <img src="adminty/assets/images/widget/watherstar2.png" alt="whether image" class="snow2">
                                                        <img src="adminty/assets/images/widget/watherbottom.png" alt="whether image" class="bottom-img">
...
<![endif]-->
    ...
    <!-- Chart js -->
    <script type="text/javascript" src="{{ asset('adminty/bower_components/chart.js/js/Chart.js') }}"></script>
    <!-- amchart js -->
    <script type="text/javascript" src="{{ asset('adminty/assets/pages/dashboard/amchart/js/amcharts.js') }}"></script>
    <script type="text/javascript" src="{{ asset('adminty/assets/pages/dashboard/amchart/js/serial.js') }}"></script>
    <script type="text/javascript" src="{{ asset('adminty/assets/pages/dashboard/amchart/js/light.js') }}"></script>
    <!-- Custom js -->
    <script type="text/javascript" src="{{ asset('adminty/assets/pages/dashboard/custom-dashboard.min.js') }}"></script>
    <script src="{{ asset('adminty/assets/js/pcoded.min.js') }}"></script>
    <script src="{{ asset('adminty/assets/js/horizontal-layout.min.js') }}"></script>
...
<script async="" src="{{ asset('adminty/assets/pages/googletag/gtag.js') }}"></script>
<script>
