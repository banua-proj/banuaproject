 ...
 <head>
   ...
   <title>Banua-Proj | Dashboard</title>
 ...
 <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left: 0px;">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <button class="btn btn-block btn-primary" type="button">Login User</button>
      </li>
    </ul>
  </nav>

 <body class="hold-transition sidebar-mini layout-fixed" style="height: auto;padding-top: 0%;">
